"object" == typeof navigator &&
  (function (e, t) {
    ...
    const We = {
        ...
        fe.call(
          ...
          (i) => {
            ...
            if (!s && [32, 39].includes(i.which)) We.showMenuPanel.call(this, t, !0);
              ...
              let t;
              32 !== i.which &&
                (40 === i.which || (s && 39 === i.which) ? ((t = e.nextElementSibling), H(t) || (t = e.parentNode.firstElementChild)) : ((t = e.previousElementSibling), H(t) || (t = e.parentNode.lastElementChild)), ue.call(this, t, !0));
            }
          },
          !1
        ),
      ...
      updateVolume() {
        this.supported.ui &&
          (H(this.elements.inputs.volume) && We.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume), H(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume));
      },
      setRange(e, t = 0) {
    ...
    const Ye = {
        setup() {
          ...
          var e, t;
          if (
            (H(this.elements.captions) || ((this.elements.captions = Z("div", ne(this.config.selectors.captions))), (e = this.elements.captions), (t = this.elements.wrapper), H(e) && H(t) && t.parentNode.insertBefore(e, t.nextSibling)),
            Y.isIE && window.URL)
          ) {
